...
Namespace TabsLayoutCustomization.Module.Win
   Partial Public Class TabsLayoutCustomizationWindowsFormsModule
      ''' <summary> 
      ...
      Private Sub InitializeComponent()
         ...
         ' 
         Me.RequiredModuleTypes.Add(GetType(TabsLayoutCustomization.Module.TabsLayoutCustomizationModule))
