...
Namespace TabsLayoutCustomization.Win
   Partial Public Class TabsLayoutCustomizationWindowsFormsApplication
      ...
      End Sub
      Private Sub TabsLayoutCustomizationWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch

            e.Updater.Update()
            e.Handled = True

      End Sub
      Private Sub TabsLayoutCustomizationWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs) Handles MyBase.CustomizeLanguagesList
